...
type Section = 'gestion'; // Tipos de secciones

const EHS = () => {
  const [isSidebarOpen, setIsSidebarOpen] = useState(false);
  const [activeSection, setActiveSection] = useState<Section>('gestion'); // Sección activa
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="flex">
        ...
        <div className="flex-1 p-4">
          ...
          {activeSection === 'gestion' && <GestionAccidentes />}
        </div>
      </div>
    </div>
  );
