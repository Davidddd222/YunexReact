...
const [filteredDocumentos, setFilteredDocumentos] = useState(reparacionesData);
    ...
    return (
        <div>
            ...
            <p className='text-xl font-semibold text-center text-gray-900 mb-6'>This is the Poliza todo Riesgo information page.</p>
