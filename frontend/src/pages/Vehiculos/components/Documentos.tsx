...
const Documentos: React.FC = () => {
  ...
  return (
    <div>
      <h1 className='text-3xl font-bold text-center text-gray-900 mb-2'>DOCUMENTOS Y HOJAS DE VIDA</h1>
      <p className='text-xl font-semibold text-center text-gray-900 mb-6'>Bienvenido a la página de Documentos.</p>
