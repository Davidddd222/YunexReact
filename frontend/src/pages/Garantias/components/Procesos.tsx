...
const Procesos: React.FC = () => {
    ...
    return (
        <div>
            <h1 className='text-3xl font-bold text-center text-gray-900 mb-2'>PROCESOS</h1>
            <p className='text-xl font-semibold text-center text-gray-900 mb-6'>Carpetas</p>

            <div className="flex flex-wrap items-center  gap-4 mb-6">
                <h1 className='text-2xl font-semibold text-center text-gray-900  bg-gray-200 rounded-sm'>ARCHIVOS - PROCESOS</h1>

                <Sheet>
               <SheetTrigger
                 className="border ml-51 border-blue-500 text-blue-500  hover:bg-blue-500 hover:text-white px-6 py-3 rounded-md transition-all ease-in-out duration-300 transform hover:scale-105 focus:outline-none focus:ring-1 focus:ring-blue-500">
                   Agregar archivo
                   </SheetTrigger>
